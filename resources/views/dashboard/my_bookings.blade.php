        ...
        <div class="flex flex-col gap-3 px-4">
          ...
          @forelse(Auth::user()->bookings as $booking)
            <a href="trip-details.html" class="card">
                ...
                <p class="text-center text-sm leading-[22px] tracking-035"><span class="text-2xl font-semibold">12</span> <br> Apr <br> 2024</p>
                <div class="flex items-center gap-4">
                    ...
                    <p class="text-sm leading-[22px] tracking-035 text-darkGrey">3 days | 2 packs</p>
