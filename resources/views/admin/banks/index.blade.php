<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-row items-center justify-between">
            ...
            <a href="{{ route('admin.package_banks.create') }}" class="px-6 py-4 font-bold text-white bg-indigo-700 rounded-full">
                Add New
            </a>
        </div>
    </x-slot>
                ...
                @forelse($banks as $bank)
                    <div class="flex flex-row items-center justify-between item-card">
                        ...
                        <div class="flex-row items-center hidden md:flex gap-x-3">
                            <a href="{{ route('admin.package_banks.edit', $bank) }}" class="px-6 py-4 font-bold text-white bg-indigo-700 rounded-full">
                                Edit
                            </a>
